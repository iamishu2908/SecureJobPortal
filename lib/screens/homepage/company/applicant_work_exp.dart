...
class ApplicantWorkExperience extends StatefulWidget {
  String id;
  ApplicantWorkExperience({super.key, required this.id});

  @override
  State<ApplicantWorkExperience> createState() => _ApplicantWorkExperienceState();
}

class _ApplicantWorkExperienceState extends State<ApplicantWorkExperience> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
            stream: ref.doc(widget.id).collection('work_exp').snapshots(),
