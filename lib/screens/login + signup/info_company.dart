              ...
              children: <Widget>[
                ...
                Row(children: <Widget>[
                  reusableTextContainer(
                      "LinkedIn*", MediaQuery.of(context).size.width * 0.46),
                  reusableTextContainer(
                      "Website", MediaQuery.of(context).size.width * 0.4),
                ]),
                Row(children: <Widget>[
                  Expanded(
                    child: reusableTextField(
                        "www.linkedin.com", false, _linkedInTextController),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: reusableTextField(
                        "www.website.com", false, _websiteTextController),
                  ),
                ]),
                const SizedBox(
                  height: 20,
                ...
                Row(children: <Widget>[
                  reusableTextContainer(
                      "Location*", MediaQuery.of(context).size.width * 0.46),
                  reusableTextContainer(
                      "Company Type*", MediaQuery.of(context).size.width * 0.4),
                ]),
                Row(children: <Widget>[
                  Expanded(
                    child: reusableTextField(
                        "Enter Location", false, _locationTextController),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: reusableTextField(
                        "Enter Type", false, _comTypeTextController),
                  ),
                ]),
                const SizedBox(
                  height: 20,
                ...
                Row(children: <Widget>[
                  reusableTextContainer(
                      "Twitter", MediaQuery.of(context).size.width * 0.46),
                  reusableTextContainer("Industry Type*",
                      MediaQuery.of(context).size.width * 0.4),
                ]),
                Row(children: <Widget>[
                  Expanded(
                    child: reusableTextField(
                        "www.twitter.com/", false, _twitterTextController),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: reusableTextField(
                        "Enter Type", false, _industryTypeTextController),
                  ),
                ]),
                const SizedBox(
                  height: 20,
                ...
                reusableTextContainer(
                    "About Company", MediaQuery.of(context).size.width),
