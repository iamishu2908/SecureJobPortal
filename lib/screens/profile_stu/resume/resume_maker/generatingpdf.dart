          ...
          build: (context) {
            return Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 2),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: <Widget>[_UrlText("LinkedIn: ${user.linkedin}", '${user.linkedin}'),  Text("Mobile: ${user.mobile}")]),
                  SizedBox(height: 2),
                  _UrlText("Github: ${user.github}", '${user.github}'),
                  SizedBox(height: 10),
